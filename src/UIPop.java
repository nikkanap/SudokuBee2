...
public class UIPop extends generalPanel{
	...
	private void sixteenButtons(){
		...
		field = addTextField(panel, "", 230, 140,40,35);
	}

	// WORK IN PROGRESS
	private void twentyFiveButtons(){
		btn = new JButton[25];
		int incrX = 45, incrY = 41;
		int x1 = 151, x2 = 129;
		int y = 172;

		erase = addButton(panel, "img/box/misc/clear_25x25.png", 173,132);
		cancel = addButton(panel, "img/box/misc/cancel_25x25.png", 309,132);
		btn[0] = addButton(panel, "img/box/25x25/normal/1.png", x1, y);
		btn[1] = addButton(panel, "img/box/25x25/normal/2.png", x1 + incrX, y);
		btn[2] = addButton(panel, "img/box/25x25/normal/3.png", x1 + incrX * 2, y);
		btn[3] = addButton(panel, "img/box/25x25/normal/4.png", x1 + incrX * 3, y);
		btn[4] = addButton(panel, "img/box/25x25/normal/5.png", x1 + incrX * 4, y);
		btn[5] = addButton(panel, "img/box/25x25/normal/6.png", x2, y + incrY);
		btn[6] = addButton(panel, "img/box/25x25/normal/7.png", x2 + incrX, y + incrY);
		btn[7] = addButton(panel, "img/box/25x25/normal/8.png", x2 + incrX * 2, y + incrY);
		btn[8] = addButton(panel, "img/box/25x25/normal/9.png", x2 + incrX * 3, y + incrY);
		btn[9] = addButton(panel, "img/box/25x25/normal/10.png", x2 + incrX * 4, y + incrY);
		btn[10] = addButton(panel, "img/box/25x25/normal/11.png", x2 + incrX * 5, y + incrY);
		btn[11] = addButton(panel, "img/box/25x25/normal/12.png", x1, y + incrY * 2);
		btn[12] = addButton(panel, "img/box/25x25/normal/13.png", x1 + incrX, y + incrY * 2);
		btn[13] = addButton(panel, "img/box/25x25/normal/14.png", x1 + incrX * 2, y + incrY * 2);
		btn[14] = addButton(panel, "img/box/25x25/normal/15.png", x1 + incrX * 3, y + incrY * 2);
		btn[15] = addButton(panel, "img/box/25x25/normal/16.png", x1 + incrX * 4, y + incrY * 2);
		btn[16] = addButton(panel, "img/box/25x25/normal/17.png", x2 + incrX, y + incrY * 3);
		btn[17] = addButton(panel, "img/box/25x25/normal/18.png", x2 + incrX * 2, y + incrY * 3);
		btn[18] = addButton(panel, "img/box/25x25/normal/19.png", x2 + incrX * 3, y + incrY * 3);
		btn[19] = addButton(panel, "img/box/25x25/normal/20.png", x2 + incrX * 4, y + incrY * 3);
		btn[20] = addButton(panel, "img/box/25x25/normal/21.png", x1 + incrX, y + incrY * 4);
		btn[21] = addButton(panel, "img/box/25x25/normal/22.png", x1 + incrX * 2, y + incrY * 4);
		btn[22] = addButton(panel, "img/box/25x25/normal/23.png", x1 + incrX * 3, y + incrY * 4);
		btn[23] = addButton(panel, "img/box/25x25/normal/24.png", x2 + incrX * 2, y + incrY * 5);
		btn[24] = addButton(panel, "img/box/25x25/normal/25.png", x2 + incrX * 3, y + incrY * 5);
		field = addTextField(panel, "", 212, 123,80,30);
	}
